...
import static Vistas.IngresarTratamiento.tblProductosDeTratamiento;
 ...
 * @author PC
 */
public class ProductoParaTratamiento extends javax.swing.JFrame {
     ...
     */
    public ProductoParaTratamiento() {
        initComponents();
...
//tblProductosParafactura.getTableHeader().setReorderingAllowed(false);
        Controlador.ProductosTratamiento.ProductoParaTratamiento("");
            ...
            tblProductosParaTratamiento.addMouseListener(new MouseAdapter() {
    ...
    public void filtrarDatosProductos(String valor){
        String[] titulos = {"<html><div style='width: 50px;'>Num.</div></html>", "<html>Nombre del Producto</html>"};
        ...
        try {
            ...
            ProductoParaTratamiento.tblProductosParaTratamiento.setModel(modelo);
    ...
    private void initComponents() {
        ...
        tblProductosParaTratamiento = new javax.swing.JTable();
        ...
        setTitle("Ingresar productos a tratamiento");
        ...
        tblProductosParaTratamiento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblProductosParaTratamiento.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblProductosParaTratamientoMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblProductosParaTratamiento);
        if (tblProductosParaTratamiento.getColumnModel().getColumnCount() > 0) {
            tblProductosParaTratamiento.getColumnModel().getColumn(0).setMinWidth(50);
            tblProductosParaTratamiento.getColumnModel().getColumn(0).setMaxWidth(50);
            tblProductosParaTratamiento.getColumnModel().getColumn(2).setMinWidth(0);
            tblProductosParaTratamiento.getColumnModel().getColumn(2).setMaxWidth(0);
            tblProductosParaTratamiento.getColumnModel().getColumn(3).setMinWidth(0);
            tblProductosParaTratamiento.getColumnModel().getColumn(3).setMaxWidth(0);
            tblProductosParaTratamiento.getColumnModel().getColumn(4).setMinWidth(0);
            tblProductosParaTratamiento.getColumnModel().getColumn(4).setMaxWidth(0);
        }
    ...
    private void tblProductosParaTratamientoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductosParaTratamientoMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tblProductosParaTratamientoMouseClicked
    ...
    private void btnAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProductoActionPerformed
        int fila = tblProductosParaTratamiento.getSelectedRow();
        ...
        try {
            ...
            DefaultTableModel modelo = (DefaultTableModel) tblProductosParaTratamiento.getModel();
            id = tblProductosParaTratamiento.getValueAt(fila, 1).toString();
            nombreProd = tblProductosParaTratamiento.getValueAt(fila, 0).toString();
            
            //Enviar los campos seleccionados de la tabla de productos a la tabla de factura de compras
            //modelo = (DefaultTableModel) tblProductosCompra.getModel();
            ...
            for (int i = 0; i < modelo.getRowCount(); i++) {
                ...
                if (productoEncontrado) {
                    ...
                    String filaElemento[] = {id, nombreProd};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoParaTratamiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoParaTratamiento().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tblProductosParaTratamiento;

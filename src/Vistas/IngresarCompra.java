...
public class IngresarCompra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblProductosCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre del producto", "Marca", "Presentación", "Cantidad", "Precio", "Subtotal", "Precio de venta"
            }
        ) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        PreparedStatement verificarExistencia = conection.prepareStatement("SELECT Cantidad, Precio, Precio_venta FROM inventarioproductos WHERE Producto = ? AND Marca = ? AND tipo_Producto = ?");
        ...
        if (resultSet.next()) {
            ...
            actualizarExistente.setDouble(3, nuevoPrecioVenta);
            actualizarExistente.setString(4, producto);
            actualizarExistente.setString(5, Marca);
            ...
            insertarNuevo.setDouble(6, precio_venta);
